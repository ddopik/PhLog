            ...
            case UPLOAD_FILE:
                ...
                if (message.obj instanceof UploadImageData) {
                    ...
                    switch (object.getUploadImageType()) {
                        ...
                        case NORMAL_IMG:
                            Disposable d1 = BaseNetworkApi.uploadPhotoGrapherPhoto(token, object.getImageCaption(), object.getImageLocation(), imageFile, object.getTags(), object.getFilters(), object.isExclusive(), (bytesUploaded, totalBytes) -> {
                            ...
                            break;
                        case CAMPAIGN_IMG:
                            Disposable d2 = BaseNetworkApi.uploadCampaignPhoto(token, object.getImageCaption(), object.getImageLocation(), imageFile, object.getTags(), object.getFilters(), object.getImageId(), object.isExclusive())
                                    .subscribeOn(Schedulers.io())
                                    .observeOn(AndroidSchedulers.mainThread())
                                    .subscribe(responseConsumer, throwableConsumer);
                            disposables.add(d2);
