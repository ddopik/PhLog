...
public class CommentsAdapter extends RecyclerView.Adapter<CommentsAdapter.CommentViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CommentViewHolder commentViewHolder, int i) {
        ...
        if (getItemViewType(i) == 0) {
            ...
            if (previewImage.likeCount != null)
                commentViewHolder.imgLikeVal.setText(new StringBuilder().append(previewImage.likeCount).append(" ").append(context.getResources().getString(R.string.like)).toString());
            if (previewImage.commentCount != null)
                commentViewHolder.imgCommentVal.setText(new StringBuilder().append(previewImage.likeCount).append(" ").append(context.getResources().getString(R.string.comment)).toString());
