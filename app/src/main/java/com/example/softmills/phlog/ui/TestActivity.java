 ...
 */
public class TestActivity extends BaseActivity implements FiltersListFragment.FiltersListFragmentListener, EditPickedImageFragment.EditImageFragmentListener {
    ...
    EditPickedImageFragment editImageFragment;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK && requestCode == SELECT_GALLERY_IMAGE) {
            ...
            filtersListFragment.prepareThumbnail(originalImage,IMAGE_NAME);
        }
    }
